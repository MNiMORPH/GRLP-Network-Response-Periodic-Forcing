...
# variables
out="../../Figures/Figure_S7_Network_z_Q_Gain_Lag_N1_2-102"
proj=-JX1.5il/1.5i
...
for i in ${!sweepdirs[@]} ; do
  ...
  gmt psxy $basedir/MC_N1_2-102/${sweepdirs[$i]}/z_Q_gain.pg $rgn $proj -Sc3p -W0.8p,steelblue -Ey+a+p0.8p,steelblue+w2p -t95 -O -K >> $out.ps
  ...
  gmt psxy $basedir/MC_N1_2-102/${sweepdirs[$i]}/z_Q_lag.pl $rgn_l $proj -Sc3p -W0.8p,steelblue -Ey+a+p0.8p,steelblue+w2p -t95 -O -K >> $out.ps
