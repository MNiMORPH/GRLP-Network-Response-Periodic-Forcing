...
cross_plot () {
  ...
  gmt psbasemap $rgn $proj \
    -Bn$axes \
    -Bx$dx+l"$lab" \
    -By40+l"Effective length, @[\widehat{\textit{L}}@[ [km]" \
    -O -K >> $out.ps  
}
...
# ---- Plot Part A
out=../../Figures/Figure_S5a_Network_Effective_Length_X-Plots_N1_40
R_B_labs=("a" "g" "m" "s")
R_L_labs=("b" "h" "n" "t")
R_Q_labs=("c" "i" "o" "u")
K_labs=("d" "j" "p" "v")
...
# ---- Plot Part B
out=../../Figures/Figure_S5b_Network_Effective_Length_X-Plots_N1_40
