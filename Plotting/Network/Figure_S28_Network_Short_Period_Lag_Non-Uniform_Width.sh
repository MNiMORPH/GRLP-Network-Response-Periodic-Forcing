...
# ---- Inputs / Output
basedir="../../Output/Network/Figure_S28_Network_Short_Period_Lag_Non-Uniform_Width"
out="../../Figures/Figure_S28_Network_Short_Period_Lag_Non-Uniform_Width"
...
gmt psxy $basedir/UUN_Qs_lag.pl $rgn_l $proj -Sc2.5p -t50 -Cinlet.cpt -O -K >> $out.ps
...
gmt psxy $basedir/NUN_Qs_lag.pl $rgn_l $proj -Sc2.5p -t50 -Cinlet.cpt -O -K >> $out.ps
