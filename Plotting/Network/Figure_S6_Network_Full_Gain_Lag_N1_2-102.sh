...
# variables
out="../../Figures/Figure_S6_Network_Full_Gain_Lag_N1_2-102"
proj=-JX1.5il/1.5i
...
for i in ${!sweepdirs[@]} ; do
  ...
  gmt psxy $basedir/MC_N1_2-102/${sweepdirs[$i]}/z_gain.pg $rgn $proj -Sc3p -W0.8p,steelblue -Ey+a+p0.8p,steelblue+w2p -t95 -O -K >> $out.ps
  ...
  gmt psxy $basedir/MC_N1_2-102/${sweepdirs[$i]}/z_lag.pl $rgn_l $proj -Sc3p -W0.8p,steelblue -Ey+a+p0.8p,steelblue+w2p -t95 -O -K >> $out.ps
  ...
  gmt psxy $basedir/MC_N1_2-102/${sweepdirs[$i]}/Qs_gain.pg $rgn $proj -Sc3p -W0.8p,steelblue -t92 -O -K >> $out.ps
  ...
  gmt psxy $basedir/MC_N1_2-102/${sweepdirs[$i]}/Qs_lag.pl $rgn_l $proj -Sc3p -W0.8p,steelblue -t92 -O -K >> $out.ps
  ...
  gmt psxy $basedir/MC_N1_2-102/${sweepdirs[$i]}/Qs_Qw_gain.pg $rgn $proj -Sc3p -W0.8p,steelblue -t92 -O -K >> $out.ps
  ...
  gmt psxy $basedir/MC_N1_2-102/${sweepdirs[$i]}/Qs_Qw_lag.pl $rgn_l $proj -Sc3p -W0.8p,steelblue -t92 -O -K >> $out.ps
