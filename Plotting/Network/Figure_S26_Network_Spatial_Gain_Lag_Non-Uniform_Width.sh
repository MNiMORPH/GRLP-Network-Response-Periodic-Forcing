...
basedir_ref="../../Output/Network/Figure_15_Network_Spatial_Gain_Lag"
out="../../Figures/Figure_S26_Network_Spatial_Gain_Lag_Non-Uniform_Width"
...
for p in "fast" "medium" "slow" ; do
  ...
  for i in ${!nets[@]} ; do
    ...
    indir_ref=$basedir_ref/${nets_ref[$i]}
    ...
    gmt psxy $indir_ref/$p/lag.dl $rgn_lag $proj -Wlightgrey -O -K >> $out.ps
