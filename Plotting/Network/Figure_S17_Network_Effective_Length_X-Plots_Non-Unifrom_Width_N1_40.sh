...
# ---- Variables
out=../../Figures/Figure_S17_Network_Effective_Length_X-Plots_Non-Uniform_Width_N1_40
basedir="../../Output/Network/Figure_S16_S17_S18_Network_Effective_Length_Controls_Non-Uniform_Width"
...
for i in ${!cases[@]} ; do
  ...
  awk ' { print $1, $8 } ' $basedir/N1_40_${cases[$i]}.dat | \
  ...
  awk ' { print $2, $8 } ' $basedir/N1_40_${cases[$i]}.dat | \
    gmt psxy $rgn $proj -Sc2.5p -W0.8p,steelblue -t70 -O -K >> $out.ps
  ...
  rgn=-R0/6/35/115
  gmt psbasemap $rgn $proj -B+n -X1.15i -O -K >> $out.ps
  awk ' { print $3, $8 } ' $basedir/N1_40_${cases[$i]}.dat | \
    gmt psxy $rgn $proj -Sc2.5p -W0.8p,steelblue -t70 -O -K >> $out.ps
  ...
  rgn=-R0/12/35/115
  gmt psbasemap $rgn $proj -B+n -X1.15i -O -K >> $out.ps
  awk ' { print $4, $8 } ' $basedir/N1_40_${cases[$i]}.dat | \
    gmt psxy $rgn $proj -Sc2.5p -W0.8p,steelblue -t70 -O -K >> $out.ps
  ...
  rgn=-R0/12/35/115
  gmt psbasemap $rgn $proj -B+n -X1.15i -O -K >> $out.ps
  awk ' { print $5, $8 } ' $basedir/N1_40_${cases[$i]}.dat | \
    gmt psxy $rgn $proj -Sc2.5p -W0.8p,steelblue -t70 -O -K >> $out.ps
  ...
  rgn=-R30/100/35/115
  gmt psbasemap $rgn $proj -B+n -X1.15i -O -K >> $out.ps
  awk ' { print $7, $8 } ' $basedir/N1_40_${cases[$i]}.dat | \
    gmt psxy $rgn $proj -Sc2.5p -W0.8p,steelblue -t70 -O -K >> $out.ps
