...
corrfiles=("corr_m40_fix_seg_length_no_internal_var_width.dat" "corr_m40_rnd_seg_length_no_internal_var_width.dat" "corr_m40_fix_seg_length_w_internal_var_width.dat" "corr_m40_rnd_seg_length_w_internal_var_width.dat")
sweepfiles=("m40_fix_seg_length_no_internal_var_width.dat" "m40_rnd_seg_length_no_internal_var_width.dat" "m40_fix_seg_length_w_internal_var_width.dat" "m40_rnd_seg_length_w_internal_var_width.dat")
groups=("fix_seg_length_no_internal_var_width" "rnd_seg_length_no_internal_var_width" "fix_seg_length_w_internal_var_width" "rnd_seg_length_w_internal_var_width")
corr_labels=("a" "b" "c" "d")
Le_labels=("e" "f" "g" "h")
Le2_labels=("i" "j" "k" "l")
...
$k 0" | gmt psxy $rgn $proj -Gtomato -W0.1p,tomato -O -K >> $out.ps
  ...
  gmt psbasemap -R0/40/25/95 $proj_hist2 -BrN -Bx20 -O -K >> $out.ps
  ...
  proj_hist2=-JX-0.3i/1.5i
  rgn_hist2=-R25/95/0/120
  awk ' { print $7 } ' $basedir/m2-150_${groups[$i]}.dat | \
    gmt pshistogram $rgn_hist2 $proj_hist2 -Ggrey -T30+n -X1.2i -A -O -K >> $out.ps
  echo "Count:" | gmt pstext $rgn_hist2 $proj_hist2 -F+f7p+jBR+cTR -D-0.4i/0.08i -N -O -K >> $out.ps
  gmt psbasemap -R0/120/25/95 $proj_hist2 -BrN -Bx60 -O -K >> $out.ps
