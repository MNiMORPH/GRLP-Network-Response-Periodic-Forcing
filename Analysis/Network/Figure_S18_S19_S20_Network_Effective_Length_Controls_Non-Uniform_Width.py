"""
This script performs the analysis presented in Figures S18, S19 and S20;
produces a rough version of the Figures; and, optionally, generates output
files for plotting the final Figures in GMT.
...
Here, in contrast with Figures 11, S5, and S6, valley width is set to increase
