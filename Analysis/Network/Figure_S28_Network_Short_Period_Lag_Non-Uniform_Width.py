"""
This script performs the analysis presented in Figure S28; produces a rough
...
Here, in contrast with Figure 17, valley width is set to increase
...
for p in [0,1,2,3]:
    ...
    for i,case in enumerate(['UUN', 'NUN']):
