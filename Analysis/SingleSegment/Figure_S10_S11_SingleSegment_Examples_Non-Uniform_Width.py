...
al. (2024, EGUsphere); produces a rough version of the Figure; and, optionally,
...
if output_gmt:
    ...
    basedir = "../../Output/SingleSegment/" + \
        "Figure_S10_S11_SingleSegment_Examples_Non-Uniform_Width/"
